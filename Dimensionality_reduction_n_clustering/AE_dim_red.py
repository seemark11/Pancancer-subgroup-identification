...
# Path to input file
ip_training_file = "combined_dataset.csv"
# Path to output file
op_file = "AE_reduced_dataset.csv"
# Save checkpoints while training
checkpoint_filepath = "AE_reduced_dataset_{epoch:02d}_{val_loss:.2f}.hdf5"
# Path to save AE loss image
fig_path =  "AE_reduced_dataset_loss.png"
